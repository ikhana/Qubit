...
needs, providing flexibility and value for every user.</Paragraph>
                    <Grid container display={"flex"} justifyContent={"space-between"} gap="20px 0">
                        ...
                        <Grid item xs={12} md={5.9} display="flex" sx={{flexDirection:{xs:'column',sm:'row'}}} gap="20px">
                            <PricingCards btnbg="#000000 !important" btnborder="1px solid #707070 !important"  pkgType="Introductory" pkgAmopunt="$5" pkgDuration="1 Month" />
                            <PricingCards  maxWidth="calc(100% - 4px)" pkgType="Popular" pkgAmopunt="$55" pkgDuration="12 Month" sx={{background:"linear-gradient(to bottom,#FFFFFF,#6137EA)"}} c="#000" b="2px solid #fff"/>
